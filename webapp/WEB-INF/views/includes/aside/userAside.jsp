...
<body>
	...
	<nav class="navbar navbar-dark bg-primary align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" id="user-aside">
        <div class="container-fluid d-flex flex-column p-0"><img data-bss-hover-animate="pulse" id="bujang-logo" width="159" height="38" src="assets/img/bujang-logo.png" href="../../../index.html">
